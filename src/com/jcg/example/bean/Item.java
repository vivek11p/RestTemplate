...
*/
	...
	public String toString() {
		return "Item [id=" + id + ", name=" + name + ", fullName=" + fullName
				+ ", repository=" + repository + ", owner=" + owner
				+ ", _private=" + _private + ", htmlUrl=" + htmlUrl
				+ ", description=" + description + ", fork=" + fork + ", url="
				+ url + ", homepage=" + homepage + ", size=" + size
				+ ", stargazersCount=" + stargazersCount + ", watchersCount="
				+ watchersCount + ", language=" + language + ", hasIssues="
				+ hasIssues + ", hasDownloads=" + hasDownloads + ", hasWiki="
				+ hasWiki + ", hasPages=" + hasPages + ", forksCount="
				+ forksCount + ", mirrorUrl=" + mirrorUrl
				+ ", openIssuesCount=" + openIssuesCount + ", forks=" + forks
				+ ", openIssues=" + openIssues + ", watchers=" + watchers
				+ ", defaultBranch=" + defaultBranch + ", score=" + score
